...
def create_tooltips_dataframe():
    ...
    tooltip_mapping = {
        ...
        "% of Incidents + Near Misses Investigated": "This return compares the number of Incidents and Near Misses reported in the period alongside the % that have been investigated by the relevant person in the Dept, whether this be the supervisor of the reporting party, or the Health and Safety Assistants/Coordinators.",
        ...
        "% of Staff who are in date with all training requirements": "This return is an indication by the H&S Coordinator of what percentage of Staff they believe have received all training they need in order to be competent to carry out their work. This includes all compulsory training via UniCore, all training via Atlas, as well as any other training highlighted on the training matrix."
    }
